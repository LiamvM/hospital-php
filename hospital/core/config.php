...
define('DB_NAME', 'hospital'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'Patients'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
